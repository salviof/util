...
--
-- Host: localhost    Database: CJTestesHashArquivoEntidade
-- ------------------------------------------------------
...
--
-- Table structure for table `HashsDeArquivoDeEntidade`
--

DROP TABLE IF EXISTS `HashsDeArquivoDeEntidade`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `HashsDeArquivoDeEntidade` (
  `id` int(11) NOT NULL,
  `atributo` varchar(255) DEFAULT NULL,
  `entidade` varchar(255) DEFAULT NULL,
  `hashCalculado` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `HashsDeArquivoDeEntidade`
--

LOCK TABLES `HashsDeArquivoDeEntidade` WRITE;
/*!40000 ALTER TABLE `HashsDeArquivoDeEntidade` DISABLE KEYS */;
/*!40000 ALTER TABLE `HashsDeArquivoDeEntidade` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-05-27 23:38:59
